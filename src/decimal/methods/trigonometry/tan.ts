...
// tan(NaN)       = NaN
//
export function tan(x: Decimal) : Decimal
{
	if (!x.isFinite())
	{
...
// atan(NaN)       = NaN
//
export function atan(x: Decimal) : Decimal
{
...
// tanh(NaN)       = NaN
//
export function tanh(x: Decimal) : Decimal
{
	if (!x.isFinite())
	{
...
// atanh(-1)        = -Infinity
//
export function atanh(x: Decimal) : Decimal
{
	if (!x.isFinite())
	{
		return new Decimal(NaN);
