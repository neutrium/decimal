...
function test(cases)
{
    for(var i = 0; i < cases.length; i++)
    {
        ...
        it('should valueOf ' + testCase[1] + ' equal ' + testCase[0], function() {
            expect(new Decimal(testCase[1]).valueOf()).toEqual(testCase[0]);
        });
    }
    return true;
}

describe("Neutrium Decimal valueOf() Tests", function() {
    beforeEach(function() {
        Decimal.config({
            precision: 20,
            rounding: 4,
