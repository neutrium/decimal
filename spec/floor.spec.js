...
function test(cases)
{
    for(var i = 0; i < cases.length; i++)
    {
        ...
        {
            it('should floor of ' + testCase[1] + ' equal ' + testCase[0], function() {
                expect(new Decimal(testCase[1]).floor().valueOf()).toEqual(testCase[0]);
            });
        }
        else
        {
...
describe("Neutrium Decimal floor() Tests", function() {
    ...
    describe("exponential tests", function() {
        ...
        var cases = [
            ...
            ['-0', '-9.9e-9000000000000001'],  // underflow to zero
