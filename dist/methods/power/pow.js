...
//
export function pow(x, yy) {
    let e, k, pr, r, rm, sign, yIsInt, y = new Decimal(yy), yn = +y;
    ...
    // Overflow/underflow?
    if (e > Decimal.params.EXP_LIMIT + 1 || e < -Decimal.params.EXP_LIMIT - 1)
...
//
function intPow(x, n, pr) {
    let isTruncated, r = new Decimal(1), 
