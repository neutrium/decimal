...
var Decimal = (function () {
    ...
    Object.defineProperty(Decimal, "EXP_LIMIT", {
        // The maximum exponent magnitude.
        // The limit on the value of `toExpNeg`, `toExpPos`, `minE` and `maxE`.
        get: function () { return 9e15; },
        enumerable: true,
        configurable: true
    });
    ;
    ...
    Object.defineProperty(Decimal, "LN10_STR", {
        // The natural logarithm of 10 (1025 digits).
        get: function () { return '2.'; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Decimal, "PI_STR", {
        // Pi (1025 digits).
        get: function () { return '3.'; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Decimal, "LN10", {
        // Create the internal constants from their string values.
        get: function () { return new Decimal(Decimal.LN10_STR); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(Decimal, "PI", {
        get: function () { return new Decimal(Decimal.PI_STR); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(Decimal, "LN10_PRECISION", {
        get: function () { return Decimal.LN10_STR.length - 1; },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(Decimal, "PI_PRECISION", {
        get: function () { return Decimal.PI_STR.length - 1; },
        enumerable: true,
        configurable: true
    });
    ;
    ...
    Object.defineProperty(Decimal, "BASE", {
        //readonly isDecimal = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i;  // Supported in typescript 2
        get: function () { return 1e7; },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(Decimal, "LOG_BASE", {
        get: function () { return 7; },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(Decimal, "MAX_SAFE_INTEGER", {
        get: function () { return 9007199254740991; },
        enumerable: true,
        configurable: true
    });
    ;
    ...
    Decimal.prototype.cmp = function (w) {
        ...
        for (var i = 0, j = xdL < ydL ? xdL : ydL; i < j; ++i) {
            if (xd[i] !== yd[i])
    ...
    */
    ...
    Decimal.prototype.precision = function (z) {
        ...
        if (z !== void 0 && z !== !!z && z !== 1 && z !== 0)
            throw Error(Decimal.invalidArgument + z);
        if (x.d) {
    ...
    */
    Decimal.prototype.toFraction = function (maxD) {
        ...
        if (maxD == null) {
            ...
            n = new Decimal(maxD);
            if (!n.isInt() || n.lt(n1))
                throw Error(Decimal.invalidArgument + n);
    ...
    */
    Decimal.prototype.pow = function (yy) {
        ...
        if (e > Decimal.maxE + 1 || e < Decimal.minE - 1)
            return new Decimal(e > 0 ? sign / 0 : 0);
        Decimal.external = false;
    ...
    Decimal.prototype.acos = function () {
        ...
        if (x.isZero())
            return Decimal.getPi(pr + 4, rm).mul(0.5);
    ...
    Decimal.prototype.cosh = function () {
        ...
        var cosh2_x, i = k, d8 = new Decimal(8);
        for (; i--;) {
            cosh2_x = x.mul(x);
    ...
    Decimal.prototype.sinh = function () {
        ...
        if (len < 3) {
            ...
            x = this.taylorSeries(2, x, x, true);
            // Reverse argument reduction
            var sinh2_x, d5 = new Decimal(5), d16 = new Decimal(16), d20 = new Decimal(20);
            for (; k--;) {
                sinh2_x = x.mul(x);
    ...
    Decimal.prototype.atanh = function () {
        ...
        if (Math.max(xsd, pr) < 2 * -x.e - 1)
            return Decimal.finalise(new Decimal(x), pr, rm, true);
    ...
    Decimal.prototype.sine = function (x) {
        ...
        if (len < 3)
            return this.taylorSeries(2, x, x);
        ...
        // Reverse argument reduction
        var sin2_x, d5 = new Decimal(5), d16 = new Decimal(16), d20 = new Decimal(20);
        for (; k--;) {
            sin2_x = x.mul(x);
    ...
    */
    Decimal.digitsToString = function (d) {
    ...
    Decimal.prototype.checkInt32 = function (i, min, max) {
        if (i !== ~~i || i < min || i > max) {
  ...
  */
    ...
    Decimal.divide = function (x, y, pr, rm, dp, base) {
        ...
        var cmp, e, i, k, logBase, more, prod, prodL, q, qd, rem, remL, rem0, sd, t, xi, xL, yd0, yL, yz, sign = x.s == y.s ? 1 : -1, xd = x.d, yd = y.d;
    ...
    Decimal.prototype.finiteToString = function (x, isExp, sd) {
        if (!x.isFinite())
            return this.nonFiniteToString(x);
        var k, e = x.e, str = Decimal.digitsToString(x.d), len = str.length;
        if (isExp) {
            if (sd && (k = sd - len) > 0) {
            ...
            if (sd && (k = sd - e - 1) > 0)
                str = str + '.' + Decimal.getZeroString(k);
        }
        else {
            if ((k = e + 1) < len)
    ...
    Decimal.prototype.getLn10 = function (sd, pr) {
    ...
    Decimal.getPi = function (sd, rm) {
        if (sd > Decimal.PI_PRECISION)
            throw Error(Decimal.precisionLimitExceeded);
        return Decimal.finalise(Decimal.PI, sd, rm, true);
    };
    Decimal.prototype.getPrecision = function (digits) {
        var w = digits.length - 1, len = w * Decimal.LOG_BASE + 1;
        w = digits[w];
        // If non-zero...
        if (w) {
            // Subtract the number of trailing zeros of the last word.
    ...
    Decimal.getZeroString = function (k) {
        var zs = '';
        for (; k--;)
            zs += '0';
        return zs;
    ...
    */
    ...
    Decimal.minE = -Decimal.EXP_LIMIT; // -1 to -EXP_LIMIT
